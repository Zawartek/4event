...
--
-- Client :  127.0.0.1
-- Généré le :  Mar 08 Décembre 2015 à 13:52
...
(2, '10 rue de Vanves', 'Issy-les-Moulineaux', '92130', 'France'),
(3, '71 rue du Chateau', 'Crosne', '91560', 'France'),
(4, '10 rue du pain', 'Sydney', '0', 'Australie');
...
CREATE TABLE IF NOT EXISTS `evenement` (
  ...
  `evenement_description` varchar(255) COLLATE utf8_bin NOT NULL,
...
(1, 'Présentation Client', 'On présente le projet.', 1, 2, 1, '2015-12-08', '13:30:00', '2015-12-08', '17:00:00', 7, 1, '', ''),
(2, 'Tournoi de tennis', 'Open Australie.', 1, 4, 1, '2015-12-08', '10:00:00', '2015-12-08', '20:00:00', 64, 1, '', '');
...
CREATE TABLE IF NOT EXISTS `utilisateur` (
  ...
  `utilisateur_mot_de_passe` varchar(30) COLLATE utf8_bin NOT NULL,
...
(1, 'Vuong', 'Matthieu', 'matthieu.vuong@gmail.com', 1, '1995-09-13', '', 'azerty', 0, 0, 1, 1),
(2, 'Sacarabany', 'Paul', 'paul.sacarabany@gmail.com', 3, '2015-12-08', '', 'azerty', 0, 0, 1, 1);
